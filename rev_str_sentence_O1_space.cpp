...
/* This program does not take care of leading/trailing spaces */
...
void reverse2(char *str)
{
	...
	do {
		...
		if (*tmp1) {
            ...
            // The reverse1 assumes \0 termination - faking it for each word
			char ch  =*tmp1;
			*tmp1 = '\0';
			reverse1(tmp);
            // Copy over the space or fullstop character
			*tmp1 = ch;;
			tmp1++;
			tmp = tmp1;
		}
